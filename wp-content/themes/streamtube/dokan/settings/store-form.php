...
<form method="post" id="store-form" action="" class="dokan-form-horizontal">
    ...
    <?php if( ! is_author() ): ?>
        <div class="dokan-banner">
            ...
            <?php printf(
                '<div class="image-wrap%s">',
                $banner_id ? '' : ' dokan-hide'
            )?>
        ...
        <div class="dokan-form-group">
            ...
            <div class="dokan-w5 dokan-gravatar">
                ...
                <?php printf(
                    '<div class="dokan-left gravatar-wrap%s">',
                    $gravatar_id ? '' : ' dokan-hide'
                )?> 
            ...
            <div class="dokan-w5 dokan-text-left dokan_tock_check">
                <div class="checkbox">
                    <label>
                        ...
                        <?php printf(
                            '<input type="checkbox" id="dokan_store_tnc_enable" value="on" %s name="dokan_store_tnc_enable">',
                            checked( $enable_tnc, 'on', false )

                        );?>

                        <?php esc_html_e( 'Show terms and conditions in store page', 'dokan-lite' ); ?>
                    </label>
                </div>
            </div>
        </div>
            ...
            <div class="dokan-w5 dokan-text-left dokan_tock_check">
                <div class="checkbox">
                    <label for="dokan-store-time-enable" class="control-label">
                        <?php printf(
                            '<input type="checkbox" name="dokan_store_time_enabled" id="dokan-store-time-enable" value="yes" %s>',
                            checked( $dokan_store_time_enabled, 'yes', false )
                        )?>
...
<script type="text/javascript">
    ...
    (function($) {
        ...
        $( '#dokan_address_state' ).attr( 'type', 'text' );
