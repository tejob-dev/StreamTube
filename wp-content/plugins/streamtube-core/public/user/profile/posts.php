...
$heading = apply_filters( 'streamtube/core/user/profile/blog', esc_html__( 'Blog posts', 'streamtube-core' ));
...
<section class="section-profile profile-posts py-4 pb-0 m-0">
    <?php printf(
         ...
         * 
         */
        do_action( 'streamtube/core/user/profile/post/widgets/before' );

        if( is_active_sidebar( 'sidebar-profile-post' ) ):

            ob_start();

                dynamic_sidebar( 'sidebar-profile-post' );
                ...
                <div class="not-found p-3 text-center text-muted fw-normal h6"><p>
                    <?php
                     if( streamtube_core_is_my_profile() ){
                        esc_html_e( 'You have not added any posts yet.', 'streamtube-core' );
                     }
                     else{
                        printf(
                            esc_html__( '%s has not added any posts yet.', 'streamtube-core' ),
         ...
         * 
         */
        do_action( 'streamtube/core/user/profile/post/widgets/after' );
        ?>
    </div>
</section>